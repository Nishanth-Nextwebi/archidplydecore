...
var OrderStatus = [];
var totalSales = 0;
var url = 'dashboard.aspx/DashBoardD';
...
$.ajax({
    ...
    success: function (data) {
        products = data.d;
        MonthlySale = data.d.MonthNYearSale;
        MonthlyMonths = data.d.MonthNYear;
        OrderStatus = data.d.OrderStatus;
        for (var i = 0; i < MonthlySale.length; i++) {
            totalSales += MonthlySale[i];
        }
...
try {
            ...
            events: {
                mounted: function (ctx, config) {
                    ...
                    ctx.addPointAnnotation({
                        ...
                        customSVG: {
                            SVG: '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="#b10111" stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg>',
                            cssClass: undefined,
                            offsetX: -8,
                            offsetY: 5
                        }
    ...
    */
    var options = {
        ...
        colors: ['#e2a03f', '#5c1ac3', '#1b55e2', '#8dbf42', '#ff0000', '#e7515a'],
        dataLabels: {
            enabled: false
        },
        legend: {
        ...
        series: OrderStatus,
        labels: ['Initiated', 'In-Process', 'Dispatched', 'Delivered', 'Cancelled', 'Deleted'],
        responsive: [{
            breakpoint: 1599,
            options: {
                chart: {
