    ...
    $(document.body).on('click', '.deleteItem', function () {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: 'POST',
                    url: "product-specifiaction.aspx/Delete",
                    data: "{id: '" + id + "'}",
                    ...
                    success: function (data2) {
                        if (data2.d.toString() == "Success") {
                            Swal.fire({ title: "Deleted!", text: "specifiaction has been deleted.", icon: "success", confirmButtonClass: "btn btn-primary w-xs mt-2", buttonsStyling: false })
