    ...
    protected void btnLogin_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (Page.IsValid)
            {
                ...
                CreateUser logins = CreateUser.Login(conAP, inputs);
                if (logins.UserGuid != null)
                {
                    ...
                    else if (logins.Status == "Active")
                    {
                        ...
                        HttpCookie cookie = new HttpCookie("ap_aid");
                        cookie.Value = logins.UserGuid;

                        //this cookie is to validate password key
                        HttpCookie cookie_pass_key = new HttpCookie("ap_apkv");
                        ...
                        CreateUser.UpdateLastLoginTime(conAP, logins.UserGuid);
