...
public class PageMaster
{
    ...
    public static List<PageMaster> GetAllPageMaster(SqlConnection conAP)
    {
    ...
    public static int InsertPageMaster(SqlConnection conAP, PageMaster cat)
    {
        int result = 0;
    ...
    public static int UpdatePageMaster(SqlConnection conAP, PageMaster cat)
    {
        int result = 0;
    ...
    public static int DeletePageMaster(SqlConnection conAP, PageMaster cat)
    {
        int result = 0;
