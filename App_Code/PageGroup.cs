...
public class PageGroup
{
    ...
    public static List<PageGroup> GetAllPageGroup(SqlConnection conAP)
    {
    ...
    public static int InsertPageGroup(SqlConnection conAP, PageGroup cat)
    {
        int result = 0;
    ...
    public static int UpdatePageGroup(SqlConnection conAP, PageGroup cat)
    {
        int result = 0;
    ...
    public static int DeletePageGroup(SqlConnection conAP, PageGroup cat)
    {
        int result = 0;
